...
export const publisherSeeds = [
  ...
  {
    name: 'NXB Bộ Giáo Dục', status: true, createdBy: 1, updatedBy: 1,
  },
    {
    name: 'NXB Thông Tin Và Truyền Thông', status: true, createdBy: 1, updatedBy: 1,
  },
  {
    name: 'NXB Thế Giới', status: true, createdBy: 1, updatedBy: 1,
  },
]
